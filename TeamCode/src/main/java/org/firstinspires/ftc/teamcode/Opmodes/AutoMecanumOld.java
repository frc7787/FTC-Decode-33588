...
@Autonomous(name="Auto Goal Old - use if pinpoint not working", group="StarterBot")
//@Disabled
public class AutoMecanumOld extends OpMode
{
    ...
    public void loop() {
        ...
        switch (autonomousState){
            ...
            case ROTATING:
                if (driving(0.15)) {
                    initializeDrive(DriveDirection.FORWARD);
